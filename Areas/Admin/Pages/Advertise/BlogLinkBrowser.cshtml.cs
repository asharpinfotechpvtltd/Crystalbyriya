...
{
    public class BlogLinkBrowserModel : PageModel
    {
        public BlogLinkBrowserModel(IConfiguration config, IWebHostEnvironment env)
        {
            _config = config;
            _env = env;
        }
        ...
        /// </summary>
        private string FileFolderRoot => _config["BlogRoot"] != null ? $"/{_config["BlogRoot"].Trim('/')}/" : "";
